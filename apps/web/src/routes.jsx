...
const routes = [
  ...
  { path: "/silo-fleet/:serverId/items/:itemId", element: <FleetHistoryDetail type="item" />, exact: true },
  { path: "/silo-fleet/:serverId/users/:userId", element: <FleetHistoryDetail type="user" />, exact: true },
  { path: "/silo-fleet/:serverId/libraries", element: <FleetLibraries />, exact: true },
  { path: "/silo-fleet/:serverId/libraries/:libraryId", element: <FleetLibraries />, exact: true },
