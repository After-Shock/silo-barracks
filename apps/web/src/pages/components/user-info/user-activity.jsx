...
function LegacyUserActivity({ initialConfig, ...props }) {
...
export default function UserActivity(props) {
  ...
  return config.IS_SILO
    ? <SiloScopedActivity endpoint="/api/getUserHistory" body={{ userid: props.UserId }} scopeLabel="Account" config={config} />
    : <LegacyUserActivity {...props} initialConfig={config} />;
}
